...
function Notifications() {
  return (
    <div className="center">
      <>
        <Card border="primary" style={{ width: "35rem" }} className="card">
        ...
        <Card border="secondary" style={{ width: "35rem" }} className="card">
        ...
        <Card border="success" style={{ width: "35rem" }} className="card">
          <Card.Header>Header</Card.Header>
          <Card.Body>
        ...
        <Card border="warning" style={{ width: "35rem" }} className="card">
          <Card.Header>Header</Card.Header>
          <Card.Body>
        ...
        <Card border="info" style={{ width: "35rem" }} className="card">
          <Card.Header>Header</Card.Header>
          <Card.Body>
